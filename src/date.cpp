...
void date::amj_fabr()
     ...
     cout<<"entrez le jour de Fabrication : ";
     cin>>jour;
    ...
    cout<<"entrez le mois de Fabrication (mm) : ";
    cin>>mois;
    while(mois<1 || mois>12)
    {cout<<" erreur !!!!! \a\a \nreentrez le mois (mm) :";
    cin>>mois;
    }
    cout<<"entrez l'annee de Fabrication (aaaa) : ";
    cin>>annee;
    while(annee<1950 || annee>2022)
